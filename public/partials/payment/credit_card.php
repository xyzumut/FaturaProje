<?php
function renderTemplate($paymendo_utilities){
    
    $paymendo_baglanti = $paymendo_utilities->get_paymendo_connection();
    
    if (isset($_GET['order_id']) && !isset($_POST['operation'])) {
        try{
            $response = $paymendo_utilities->getOrder($_GET['order_id']);
        }catch(Exception $error){
            return '<h4>'.__('There was a problem, try again later.', 'Paymendo').'</h4>';
        }
        if (isset($response['status']) && $response['status'] == 'true' && isset($response['data'])) {
            ...
            $return='
                        <div id="mainContainerCard">
                                    ...
                                    <div class="front">
                                        ...
                                        <svg version="1.1" id="cardfront" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                            ...
                                            <g id="Front">
                                                ...
                                                <text transform="matrix(1 0 0 1 54.1064 428.1723)" id="svgname" class="st2 st5 st6">'.__('Name Surname', 'Paymendo').'</text>
                                                <text transform="matrix(1 0 0 1 54.1074 389.8793)" class="st7 st5 st8">'.__('Name Surname', 'Paymendo').'</text>
                                                <text transform="matrix(1 0 0 1 479.7754 388.8793)" class="st7 st5 st8">'.__('Expiry Date', 'Paymendo').'</text>
                                                <text transform="matrix(1 0 0 1 65.1054 241.5)" class="st7 st5 st8">'.__('Card Number', 'Paymendo').'</text>
                                                <g>
                                    ...
                                    <div class="back">
                                        <svg version="1.1" id="cardback" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                            ...
                                            C707.1,246.4,704.4,249.1,701.1,249.1z" />
                                                ...
                                                <g class="st8">
                                                    <text transform="matrix(1 0 0 1 518.083 280.0879)" class="st9 st6 st10">'.__('Security Code', 'Paymendo').'</text>
                                                </g>
                                                <rect x="58.1" y="378.6" class="st11" width="375.5" height="13.5" />
                                                <rect x="58.1" y="405.6" class="st11" width="421.7" height="13.5" />
                                                <text transform="matrix(1 0 0 1 59.5073 228.6099)" id="svgnameback" class="st12 st13">'.__('Name Surname', 'Paymendo').'</text>
                                            </g>
                                        </svg>
                                    </div>
                                </div>
                            ...
                            <div id="iframe-container"><iframe id="form-submit-iframe" style="display:none;"></iframe></div>
                            <div id="toasts">
            ...
            return '<h4>'.__('Misdirection, please first select the invoice to be paid from the invoices page.', 'Paymendo').'</h4>';
        }
    }
    else{
        return '<h4>'.__('Misdirection, please first select the invoice to be paid from the invoices page.', 'Paymendo').'</h4>';
